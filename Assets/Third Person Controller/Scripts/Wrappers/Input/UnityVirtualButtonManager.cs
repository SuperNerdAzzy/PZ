namespace Opsive.ThirdPersonController.Input.Wrappers
{
    /// <summary>
    ...
    /// </summary>
    public class UnityVirtualButtonManager : Opsive.ThirdPersonController.Input.UnityVirtualButtonManager
    {
